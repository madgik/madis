...
if __name__ == "__main__":
    ...
    sql+=["output 'list'"]
    sql+=["(help lala)"]
    sql+=[r"output '/home/meili/Desktop/throw.bsv' delimiter:* quoting:QUOTE_NONNUMERIC lineterminator:\n compression:t header:t compressiontype:gzip select * from file(/home/meili/archive/thesis/thesis-postgrad/colpref.csv);"]
    sql+=[r"output 'Return' '/home/meili/Desktop/SUCCESS' output '/home/meili/Desktop/throw.js' mode:gtable select * from file(/home/meili/archive/thesis/thesis-postgrad/colpref.csv)"]
    sql+=[r"select * from file(/home/meili/archive/thesis/thesis-postgrad/colpref.csv);"]
    ...
    sql+=[r"names select ontop(3,C3,C1) from file('/home/meili/archive/thesis/thesis-postgrad/colpref.csv') ;"]
